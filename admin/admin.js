...
function getTol(){
  return Math.max(0, Math.min(50, Number(localStorage.getItem('tolPct')||'5')))/100;
}
...
/* Barra: muestra usuario y botón salir; y bloquea botones si no es admin */
...
/* Gate: siempre exigir sesión; si viewer, redirigir a Exec */
...
/* ✅ Default de Programas igual que en Exec */
...
/* Construir todas las áreas visibles */
function buildAreas(){
  const cont=document.getElementById('areasContainer');
  cont.innerHTML='';
...
/* -------------------- Carga de áreas -------------------- */
/* ✅ Áreas limpias: si no hay datos, se añade una sola fila vacía */
...
async function refreshWeeklyAllPrograms(){
  ...
  for (const programa of programas){
    ...
    table.innerHTML=
      '<thead><tr><th>Área</th><th>KPI</th><th>Tipo</th><th>Meta (sem)</th><th>Actual (sem)</th><th>Dirección</th><th>Estado</th><th>Color</th></tr></thead>';
